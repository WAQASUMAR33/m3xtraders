        ...
        <ul className="mt-4 space-y-2">
          ...
          <li>
            ...
            {isDropdownOpen.admin && (
              <ul className="ml-8 mt-2 space-y-2">
                <li>
                  <Link href="/pricing-tables" legacyBehavior>
                    <a className="flex items-center p-2 hover:bg-blue-700 rounded">
                      <span className="ml-2">Admin Account</span>
                    </a>
                  </Link>
                ...
                <li>
                  <Link href="/pricing-tables/new" legacyBehavior>
                    <a className="flex items-center p-2 hover:bg-blue-700 rounded">
                ...
                <li>
                  <Link href="/pricing-tables/update" legacyBehavior>
                    <a className="flex items-center p-2 hover:bg-blue-700 rounded">
                      <span className="ml-2">Update Account</span>
                    </a>
                  </Link>
                </li>
              </ul>
